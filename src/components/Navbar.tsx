    ...
    <nav className="fixed top-0 w-full z-50 glass">
      <div className="container mx-auto px-4 flex justify-between items-center h-20">
        ...
        <Link href="/" className="flex items-center gap-4 group">
          ...
          <span className="athletic text-2xl tracking-tighter hidden sm:block">
            GAME<span className="text-victory-red group-hover:text-white transition-colors">TIME</span>
          </span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <button 
            ...
            className={`flex items-center gap-2 px-4 py-2 border-2 transition-all athletic text-sm ${
              isGameDay 
          ...
          >
            <Zap className={`w-4 h-4 ${isGameDay ? "fill-white" : ""}`} />
